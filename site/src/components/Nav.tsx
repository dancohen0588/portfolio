...
export function Nav() {
  return (
    <nav className="fixed inset-x-0 top-0 z-50 h-16 border-b border-[var(--border)] bg-[rgba(250,250,250,0.88)] backdrop-blur-[16px]">
      <div className="mx-auto flex h-full max-w-[1100px] items-center justify-between px-5 md:px-14">
        <Link
          href="#hero"
        ...
        <div className="flex items-center gap-9">
          ...
          <button
            ...
            className="inline-flex items-center text-sm font-bricolage font-bold text-white transition-transform hover:-translate-y-0.5 hover:shadow-[0_8px_24px_rgba(124,58,237,0.35)]"
            style={{
